  ...
  const articles = [
    {
      ...
      description:
        'Get Unix timestamps in 9 programming languages: JavaScript, Python, Java, PHP, Go, C#, Ruby, Rust & Swift',
    ...
    >
      ...
      <div className='flex-1 max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12'>
        ...
        <p className='text-base sm:text-lg mb-6 sm:mb-8 text-slate-600 dark:text-slate-400'>
          Quick reference guides for common timestamp operations across different programming
          languages.
        </p>
