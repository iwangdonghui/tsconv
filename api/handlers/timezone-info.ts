...
const COMMON_TIMEZONES: CommonTimezone[] = [
  // North America
  { identifier: 'America/New_York', displayName: 'Eastern Time', region: 'North America', popularityRank: 1, offset: -300, isDST: false },
  { identifier: 'America/Chicago', displayName: 'Central Time', region: 'North America', popularityRank: 2, offset: -360, isDST: false },
  { identifier: 'America/Denver', displayName: 'Mountain Time', region: 'North America', popularityRank: 3, offset: -420, isDST: false },
  { identifier: 'America/Los_Angeles', displayName: 'Pacific Time', region: 'North America', popularityRank: 4, offset: -480, isDST: false },
  { identifier: 'America/Phoenix', displayName: 'Arizona Time', region: 'North America', popularityRank: 15, offset: -420, isDST: false },
  { identifier: 'America/Anchorage', displayName: 'Alaska Time', region: 'North America', popularityRank: 20, offset: -540, isDST: false },
  { identifier: 'Pacific/Honolulu', displayName: 'Hawaii Time', region: 'North America', popularityRank: 18, offset: -600, isDST: false },

  // Europe
  { identifier: 'Europe/London', displayName: 'Greenwich Mean Time', region: 'Europe', popularityRank: 5, offset: 0, isDST: false },
  { identifier: 'Europe/Paris', displayName: 'Central European Time', region: 'Europe', popularityRank: 6, offset: 60, isDST: false },
  { identifier: 'Europe/Berlin', displayName: 'Central European Time', region: 'Europe', popularityRank: 7, offset: 60, isDST: false },
  { identifier: 'Europe/Rome', displayName: 'Central European Time', region: 'Europe', popularityRank: 12, offset: 60, isDST: false },
  { identifier: 'Europe/Madrid', displayName: 'Central European Time', region: 'Europe', popularityRank: 14, offset: 60, isDST: false },
  { identifier: 'Europe/Amsterdam', displayName: 'Central European Time', region: 'Europe', popularityRank: 16, offset: 60, isDST: false },
  { identifier: 'Europe/Moscow', displayName: 'Moscow Time', region: 'Europe', popularityRank: 11, offset: 180, isDST: false },

  // Asia
  { identifier: 'Asia/Tokyo', displayName: 'Japan Standard Time', region: 'Asia', popularityRank: 8, offset: 540, isDST: false },
  { identifier: 'Asia/Shanghai', displayName: 'China Standard Time', region: 'Asia', popularityRank: 9, offset: 480, isDST: false },
  { identifier: 'Asia/Kolkata', displayName: 'India Standard Time', region: 'Asia', popularityRank: 10, offset: 330, isDST: false },
  { identifier: 'Asia/Dubai', displayName: 'Gulf Standard Time', region: 'Asia', popularityRank: 13, offset: 240, isDST: false },
  { identifier: 'Asia/Singapore', displayName: 'Singapore Time', region: 'Asia', popularityRank: 17, offset: 480, isDST: false },
  { identifier: 'Asia/Seoul', displayName: 'Korea Standard Time', region: 'Asia', popularityRank: 19, offset: 540, isDST: false },

  // Australia/Oceania
  { identifier: 'Australia/Sydney', displayName: 'Australian Eastern Time', region: 'Australia', popularityRank: 21, offset: 600, isDST: false },
  { identifier: 'Australia/Melbourne', displayName: 'Australian Eastern Time', region: 'Australia', popularityRank: 22, offset: 600, isDST: false },
  { identifier: 'Australia/Perth', displayName: 'Australian Western Time', region: 'Australia', popularityRank: 25, offset: 480, isDST: false },

  // UTC
  { identifier: 'UTC', displayName: 'Coordinated Universal Time', region: 'UTC', popularityRank: 23, offset: 0, isDST: false }
];
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (req.method !== 'GET') {
    return APIErrorHandler.handleMethodNotAllowed(res, 'Only GET method is allowed for timezone info');
  }
...
async function getSpecificTimezoneInfo(timezone: string, options: { includeAliases: boolean; includeDST: boolean }): Promise<any> {
...
async function getTimezoneList(filters: { region?: string; search?: string; popular?: boolean; includeAliases: boolean }): Promise<any> {
  ...
  // Group by region
  const groupedByRegion = enrichedTimezones.reduce((acc, tz) => {
    if (!acc[tz.region]) {
      acc[tz.region] = [];
    }
...
async function getDetailedTimezoneInfo(timezone: string, date: Date, options: { includeAliases: boolean; includeDST: boolean }): Promise<TimezoneInfo | null> {
  try {
